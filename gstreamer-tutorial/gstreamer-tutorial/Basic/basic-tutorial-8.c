...
/* Phương thức này được gọi bởi idle GSource trong mainloop, để nạp CHUNK_SIZE byte vào appsrc.
  * idle handler được thêm vào mainloop khi appsrc yêu cầu chúng tôi bắt đầu gửi dữ liệu (tín hiệu cần dữ liệu)
  * và bị xóa khi appsrc có đủ dữ liệu (tín hiệu đủ dữ liệu).
  */
...
static void error_cb (GstBus *bus, GstMessage *msg, CustomData8 *data) {
  GError *err;
  gchar *debug_info;
